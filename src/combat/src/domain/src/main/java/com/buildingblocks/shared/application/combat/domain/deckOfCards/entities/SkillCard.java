package com.buildingblocks.shared.application.combat.domain.deckOfCards.entities;

import com.buildingblocks.shared.application.combat.domain.deckOfCards.values.EffectType;
import com.buildingblocks.shared.application.combat.domain.deckOfCards.values.Enhanced;
import com.buildingblocks.shared.application.combat.domain.deckOfCards.values.InitiativeCard;
import com.buildingblocks.shared.application.combat.domain.deckOfCards.values.MagicElement;
...
import com.buildingblocks.shared.application.combat.domain.deckOfCards.values.StatusCondition;
...
public class SkillCard extends Entity<SkillCardId> {
    ...
    public SkillCard(SkillCardName nameSkill, InitiativeCard initiative, EffectType typeEffect, Objetives objectives, Scope scope ) {
