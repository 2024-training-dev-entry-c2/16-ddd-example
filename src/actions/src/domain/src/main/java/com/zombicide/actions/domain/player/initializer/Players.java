...
public class Players {
	public static List<Survivor> initializrSurvivors() {
		...
		josh.getWeapons().add(new Weapon(WeaponId.of("100"), Name.of("Pistola"), Scope.of(0, 1), Damage.of(1), Dice.of(1), Precision.of(4), IsNoisy.of(true), OpenDoor.of(false)));
		...
		wanda.getWeapons().add(new Weapon(WeaponId.of("200"), Name.of("Motosierra"), Scope.of(0, 0), Damage.of(2), Dice.of(5), Precision.of(5), IsNoisy.of(true), OpenDoor.of(true)));
		...
		phil.getWeapons().add(new Weapon(WeaponId.of("300"), Name.of("Escopeta"), Scope.of(0, 1), Damage.of(2), Dice.of(2), Precision.of(4), IsNoisy.of(true), OpenDoor.of(false)));
		...
		amy.getWeapons().add(new Weapon(WeaponId.of("400"), Name.of("Hacha"), Scope.of(0, 0), Damage.of(2), Dice.of(1), Precision.of(4), IsNoisy.of(false), OpenDoor.of(true)));
		...
		doug.getWeapons().add(new Weapon(WeaponId.of("500"), Name.of("Uzi"), Scope.of(0, 1), Damage.of(1), Dice.of(3), Precision.of(5), IsNoisy.of(true), OpenDoor.of(false)));
		...
		ned.getWeapons().add(new Weapon(WeaponId.of("600"), Name.of("Palanca"), Scope.of(0, 0), Damage.of(1), Dice.of(1), Precision.of(4), IsNoisy.of(false), OpenDoor.of(true)));
